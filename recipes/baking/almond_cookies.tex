...
\noindent \desc{These are a family favorite, and it's no surprise. They require practically nothing, take little time to prepare, and pretty much everyone likes them. Even more, it's naturally dairy free because it doesn't even call for oil. You could probably soup it up a little bit by making almost an almond shortbread, but half of the beauty of these in my mind is their simplicity. They pretty much just need almond flour, lemons, almond extract and some essentials. Between the almond extract, lemon, and spices it can be easy to overpower the cookies with spices, but it's not like they will taste bad if you do ;). The powdered sugar can be substituted for a bit less than a cup of normal sugar.}
...
\item[2.] Whisk the egg whites from two eggs until they have soft peaks. 

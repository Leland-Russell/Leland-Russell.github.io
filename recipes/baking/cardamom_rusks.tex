...
\noindent \desc{These tea cookies, ``rusks'', originally for dipping in a milk-like soup work have found a use for me in tea. Originally taken from Nicole Accettola's ``Scandinavian from Scratch'', I've modified them to include more cardamom, a bit of nutmeg, and some time to chill in the fridge. I've also changed the baking process a decent bit, cooking at a little bit higher of a temperature, for a bit longer, and flipping to get a nicer and more uniform color on each side. For a richer cookie, they can be dipped in chocolate after baking.}
...
\item Place face down on the baking sheet and bake for 30-40 minutes, or until the face-down side is golden. Then flip them over and bake for another 15-20 minutes.
  \note{I've made a variant of the cookie where I dip in a chocolate mixture after baking. The thing to watch out for here is the sweetness of chocolate. If you use a more bitter chocolate, these can lose some of their appeal, just make sure you taste it for sugar.}
\end{directions}
}
